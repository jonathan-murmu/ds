...
class ForecastKPIs(AbsObserver):
    ...
    def display(self):
        print(f'Forecast current open tickets: {self.open_tickets}')
        print(f'Forecast closed tickets: {self.new_tickets}')
        print(f'Forecast new tickets: {self.closed_tickets}')
